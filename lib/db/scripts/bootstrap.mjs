...
CREATE TABLE IF NOT EXISTS "scans" (
  ...
  "sources" jsonb DEFAULT '["nvd", "cisa"]'::jsonb NOT NULL,
  "period_start" text,
  "period_end" text,
...
ALTER TABLE "scans" ADD COLUMN IF NOT EXISTS "sources" jsonb DEFAULT '["nvd", "cisa"]'::jsonb NOT NULL;
ALTER TABLE "scans" ADD COLUMN IF NOT EXISTS "period_start" text;
ALTER TABLE "scans" ADD COLUMN IF NOT EXISTS "period_end" text;
